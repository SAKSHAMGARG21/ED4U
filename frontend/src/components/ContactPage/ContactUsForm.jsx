...
const ContactUsForm = () => {
    ...
    return (
        ...
        <form className='flex flex-col gap-7' action="https://api.web3forms.com/submit" method="POST" >
            <input type="hidden" name="access_key" value="b5ab8224-1820-4eb0-b9b9-d07f601ccecc"></input>
            ...
            <button type='submit'
                className='rounded-md bg-btncolor px-6 py-3 text-center text-[13px] font-bold text-black shadow-[2px_2px_0px_0px_rgba(255,255,255,0.18)] 
