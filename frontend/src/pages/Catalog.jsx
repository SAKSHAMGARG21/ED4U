...
import { getCatelogPageDetails } from "../services/operations/courseApi";
...
const Catalog = () => {
    ...
    useEffect(() => {
        const getCategoryDetails = async () => {
            setLoading(true);
            try {
                const res = await getCatelogPageDetails(categoryId);
                    ...
                    <>
                        ...
                        <div>
                            ...
                            <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
                                ...
                                <div>
                                    <CourseSlider
                                        Courses={catalogPageData?.selectedCourses.courses}
                                    />
                                </div>
                            </div>
                            ...
                            <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
                                ...
                                <div className="py-8">
                                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                                        {catalogPageData?.trendingCourses.length === 0 ? (
                                            <p className=" text-xl text-white">
                                                No Most selling courses
                                            </p>
                                        ) : (
                                            catalogPageData?.trendingCourses
                                                ?.slice(0, 4)
                                                .map((course, index) => (
                                                    // <Course_Card
                                                    //     course={course}
